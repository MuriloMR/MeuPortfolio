...
const dataInicio = [
                    (new Date(2021, 10, 1)).getTime(0), // 0
                    (new Date(2021, 10, 1)).getTime(1), // 1
                    (new Date(2022, 0, 1)).getTime(2), // 2
                    (new Date(2022, 3, 1)).getTime(3), // 3
                    (new Date(2022, 3, 1)).getTime(4), // 4
                    (new Date(2022, 1, 1)).getTime(5), // 5
                    (new Date(2021, 11, 1)).getTime(6), // 6
                    (new Date(2021, 11, 1)).getTime(7), // 7
                    ]
